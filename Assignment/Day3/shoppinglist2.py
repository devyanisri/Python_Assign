...
productList=[]
productList.append(product("Watch","200","Titan","Accessories","10%"))
productList.append(product("HarryPotter","500","Books","Fiction","30%"))
productList.append(product("Perfume","400","Titan","Grooming","40%"))
